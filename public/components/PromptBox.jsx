...
const PromptBox = ({setIsLoading,isLoading}) => {
    ...
    return (
        <form action="" className={`w-full max-w-2xl bg-[#404045] p-4 rounded-3xl mt-4 transition-all`}>
            <textarea
            ...
            <div className='flex items-center justify-between text-sm'>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <button
                        type="submit"
                        className={`${prompt ? "bg-primary" : "bg-[#71717a]"} rounded-full w-10 h-10 flex items-center justify-center`}
                    >
